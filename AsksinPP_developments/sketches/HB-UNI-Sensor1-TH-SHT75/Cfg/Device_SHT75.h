...
// 2020-11-29 FUEL4EP (Creative Commons) adaptions to Sensirion SHT75
...
#define cDEVICE_ID      { 0xF6, 0x03, 0x01 }
#define cDEVICE_SERIAL  "SHT75SENS1"
...
#define SENSOR_SHT75      // SHT75_DATAPIN / SHT75_CLKPIN define weiter unten muss zur HW passen!
...
#define SHT75_DATAPIN     A4
#define SHT75_CLKPIN      A5
