...
<br/>
- beobachtbar sind folgende Datenpunkte, z.B. im CCU Historian:<br/>
	+ TEMPERATURE
...
# Universeller selbstkalibrierenter Luftgütesensor auf der Basis von dem Bosch BME680 Sensor (HB-UNI-Sensor1-AQ-BME680_KF_DEBUG) mit vollautomatischer Kompensation der Abhängigkeiten von Temperatur und absoluter Luftfeuchte mit einem Kalman Filter
...
- alle wichtigen Sensorparameter können interaktiv ohne Neuprogrammierung im WebUI dernn [RaspberryMatic](https://github.com/jens-maus/RaspberryMatic) / [CCU3](https://de.elv.com/smarIt-home-zentrale-ccu3-inklusive-aio-creator-neo-lizenz-ccu-plugin-151965?fs=2591490946) eingegeben werden:
