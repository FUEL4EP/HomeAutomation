...
const struct DeviceInfo PROGMEM devinfo = {
  {0xf6, 0x06, 0x01},       // Device ID             // change 0x01 to your sensor's index number, if you use multiple HB-UNI-Sensor1-AQ-BME680_KF_DEBUG sensors, please increase the index for each sensor by 1
  "BME6800601",             // Device Serial         // change NAME to your name abbreviation, if you use multiple HB-UNI-Sensor1-AQ-BME680_KF_DEBUG sensors, please increase the index for each sensor by 1
