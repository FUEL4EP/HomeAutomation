//---------------------------------------------------------
// HB-UNI-Sensor1-THPD-SHT85    Sensirion SHT85 (Temperature, Humidity, Dewpoint) / Bosch BME280 (Pressure) Temperature, Humidity, Pressure, Dewpoint, Vapor Concentration Sensor
//                              with WebUI offset setting and optional 24h and 7 days moving average filters for the measured temperature
// Version 1.1
// (C) 2018-2020 Tom Major      (Creative Commons)
// (C) 2020-2022 FUEL4EP        (Creative Commons)          added SHT85 and adaptions to Bosch BME280 sensor /  offset setting by WebUI / dewpoint and vapor concentration
...
// alternative is an ATMega1284P based PCB like https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/PCBs/HB-UNI-SEN-BATT_ATMega1284P_E07-868MS10_FUEL4EP
...
const struct DeviceInfo PROGMEM devinfo = {
    ...
    0x11,              // Firmware version V1.1 for option 'with moving average filters'
#else
    ...
    0x10,              // Firmware version V1.0 for option 'without moving average filters'
#endif
...
public:
#ifdef CALCULATE_MOVING_AVERAGES
    void init(uint8_t msgcnt, int16_t temp, uint16_t my_humidity10, uint16_t airPressure10, int16_t dewpoint10, uint16_t vaporConcentration100, uint16_t operatingVoltage1000, bool batLow, int16_t MA_24H_temp100, int16_t MA_7D_temp100)
#else
...
#endif
    {
        ...
        DPRINT(F("msg T/H/P/D/V/O (x10, ah x100, MA x100) = "));
        DDEC(temp);DPRINT("/");
...
#else
        DDEC(operatingVoltage1000);DPRINTLN(F(" "));
#endif
...
#ifdef CALCULATE_MOVING_AVERAGES
        msg.init(msgcnt, temperature10, humidity10, airPressure10, dewpoint10, vaporConcentration100, operatingVoltage1000, device().battery().low(), MA_24H_temp100, MA_7D_temp100);
#else
...
#endif
#ifdef CALCULATE_MOVING_AVERAGES
        MA_24H_temp100        = SHT85_BME280.moving_average_24h_temperature100();
        MA_7D_temp100         = SHT85_BME280.moving_average_7D_temperature100();
