...
private:
    virtual uint16_t voltage()
    {
        ...
        if (adc) {
            ...
            // ADC = Vin * 1024 / Vref -> Vin = Vref * ADC / 1024 (* resistor factor); Vbandgap = Vref
#if defined M1284P
            // Vbandgap = 2.56V for ATmega1284P
            uint32_t vbat = 256UL * adc * FACTOR / 1024 / 100;  // vbat = 2560UL for measured voltage of Vbandgap = 2.56V and FACTOR = 1000
#else
            // Vbandgap = 1.1V for ATmega328P
            uint32_t vbat = 11UL * adc * FACTOR / 1024 / 10;    // vbat = 1100UL for measured voltage of Vbandgap = 1.1V and FACTOR = 1000
#endif
