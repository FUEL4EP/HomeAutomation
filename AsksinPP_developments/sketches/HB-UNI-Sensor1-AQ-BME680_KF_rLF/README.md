...
- Motivation für das neue Sensorderivat [HB-UNI-Sensor1-AQ-BME680_KF_rLF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF):
	+ der bisherige Sensor [HB-UNI-Sensor1-AQ-BME680_KF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF) zeigte als Außensensor immer dann eine schlechte Luftgüte an, wenn es regnete oder die Luftfeuchtigkeit in der Nacht hoch war. Diese Verschlechterung der berechneten Luftqualität ist offensichtlich auf eine unzureichende Kompensation des Einflusses der Luftfeuchte zurückzuführen.
	+ das war ein starker Hinweis darauf, dass meine ursprüngliche Annahme falsch bzw. nicht optimal war, dass der gemessene Widerstandswert des Bosch BME680 Sensors von der absoluten Luftfeuchtigkeit abhängig ist.
	+ daher wurde das Derivat [HB-UNI-Sensor1-AQ-BME680_KF_rLF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF) dahingehend modifiziert, dass zur Kompensation des Einflusses der Luftfeuchtigkeit die relative Luftfeuchtigkeit statt der absoluten Luftfeuchtigkeit verwendet wird. Die Änderungen sind in wenigen Codezeilen zu machen.
	+ hier erste Messergebnisse, die bereits nach wenigen Tagen deutliche Verbesserungen zeigen:
	![pic](Images/Comparison_of_Kalman_filter_compensation_of_relative_and_absolute_humidity_1.PNG)
	![pic](Images/Comparison_of_Kalman_filter_compensation_of_relative_and_absolute_humidity_2.PNG)
	+ beim dem neuen Sensor [HB-UNI-Sensor1-AQ-BME680_KF_rLF (rote Linie)](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF) hängt der kompensierte Gaswiderstand AQ_COMP_GAS_RAW nur noch sehr gering von der mit einem separaten Sensor gemessenen relativen Luftfeuchte (grüne Linie) ab.
	+ beim bisherigen Sensor [Luftgütesensor 1 vom Typ HB-UNI-Sensor1-AQ-BME680_KF (blaue Linie)](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF) hängt der kompensierte Gaswiderstand AQ_COMP_GAS_RAW sehr stark von der mit einem separaten Sensor gemessenen relativen Luftfeuchte (grüne Linie) ab.
	+ die Kompensation des Einflusses der Luftfeuchte wird bei dem neuen Sensor im Laufe der Zeit noch besser werden, da das Kalman Filter weiter einschwingen wird.
- ursprünglich abgeleitet von Jérômes ([jp112sdl](https://github.com/jp112sdl)) [HB-UNI-Sen-IAQ](https://github.com/jp112sdl/HB-UNI-Sen-IAQ) und in mehreren Derivaten verbessert
...
- **WICHTIG:** Bei einem neuen, noch nicht "eingebrannten"  BME680-Sensor sollte das Kalman-Filter nach 2..3 Monaten erneut angelernt werden, d.h. die Autokalibrierung erneut durchgeführt werden,  da sich der Widerstand des Sensors anfangs zu stark durch Alterung ändert, siehe Kapitel 'Batteriewechsel' unten. 

## Neuerungen

- **Update 04. Juni 2023**: Firmware Version 1.1 mit Kompensation der relativen Luftfeuchtigkeit
	+ der Sensor [HB-UNI-Sensor1-AQ-BME680_KF_rLF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF) ist eine verbesserte Version des Sensors [HB-UNI-Sensor1-AQ-BME680_KF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF)
	+ der Sensor [HB-UNI-Sensor1-AQ-BME680_KF_rLF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF) kompensiert den Einfluss der **relativen** Luftfeuchtigkeit auf den Sensormesswert
	+ der Sensor [HB-UNI-Sensor1-AQ-BME680_KF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF) kompensiert den Einfluss der **absoluten** Luftfeuchtigkeit auf den Sensormesswert
...
## Bitte Addon 'ep-hb-devices-addon' auf die Version >= 1.14 updaten bzw. neu installieren
...
- soll eine Neuprogrammierung **ohne Reset und Neustart der Autokalibrierung** durchgeführt werden, bitte die Batterien während des Programmiervorgangs eingelegt lassen und darauf achten, dass die OPERATING VOLTAGE **kleiner** als 3.3V ist. Das wird zum Beispiel dann benötigt, wenn die Debugversion HB-UNI-Sensor1-AQ-BME680_KF_rLF_DEBUG zur Normalversion HB-UNI-Sensor1-AQ-BME680_KF_rLF umprogrammiert werden soll.
...
![pic](Images/HB-UNI-Sensor1-AQ-BME680_KF_rLF.png)

- Basis ist das PCB [HB-UNI-SEN-BATT_ATMega1284P_E07-868MS10_FUEL4EP](../../PCBs/HB-UNI-SEN-BATT_ATMega1284P_E07-868MS10_FUEL4EP/)
...
- alle wichtigen Sensorparameter können interaktiv ohne Neuprogrammierung im WebUI der [RaspberryMatic](https://github.com/jens-maus/RaspberryMatic) / [CCU3](https://de.elv.com/smarIt-home-zentrale-ccu3-inklusive-aio-creator-neo-lizenz-ccu-plugin-151965?fs=2591490946) eingegeben werden:
	...
	+ Bitte beachten: Der LazyConfig Modus funktioniert NUR bei einem angelernten Sensor. Wird der Config-Taster nach dem Anlernen zu lange (> 6..8 Sekunden) gedrückt, funktioniert der LazyConfig Modus nicht mehr, da ein Werksreset ausgelöst wird Ein erneutes Anlernen ist dann notwendig, um den LazyConfig Mode wieder zum Funktionieren zu bringen.
	
- Ausgabe des Luftgütegrads AQ_LEVEL: normierter BME680 Gaswiderstand 0..100% (ohne Kompensation der Einflüsse von Temperatur und relativer Luftfeuchte auf die gemessene Luftgüte)
- Ausgabe der logarithmischen Luftqualität AQ_LOG10: logarithmierte normierte und kompensierte Luftqualität 0.0..4.0 (mit Kompensation der Einflüsse von Temperatur und relativer Luftfeuchte auf die gemessene Luftqualität)
...
- eine mögliche und von mir empfohlene Hardwarebasis sieht so aus:
	*  Platine [HB-UNI-SEN-BATT_ATMega1284P_E07-900MM10S_FUEL4EP](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/PCBs/HB-UNI-SEN-BATT_ATMega1284P_E07-900MM10S_FUEL4EP) mit einem Ebyte E07 900MM10S Funkmodul
		...
		* bei Interesse an bestückten Platinen bitte per PN bei bei [FUEL4EP](https://homematic-forum.de/forum/ucp.php?i=pm&mode=compose&u=20685) anfragen
    +  oder Platine [HB-UNI-SEN-BATT_ATMega1284P_E07-868MS10_FUEL4EP](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/PCBs/HB-UNI-SEN-BATT_ATMega1284P_E07-868MS10_FUEL4EP) mit einem Ebyte E07 868MS10 Funkmodul (rote Platine), das ein wenig teurer als das noname grüne CC1101 Funkmodul ist, aber weniger Ärger macht, und JLCPCB SMD-Bestückung
...
- Bitte vor dem Aufspielen des eigentlichen Sketches HB-UNI-Sensor1-AQ-BME680_KF_rLF UNBEDINGT einen [Frequenztest ATMega1284P](FreqTest_1284P/FreqTest_1284P.ino) durchführen. Viele CC1101 Module lassen sich ohne diesen Frequenztest nicht anlernen!
...
7. Gegebenenfalls die Parameter Device ID und Device Serial in [HB-UNI-Sensor1-AQ-BME680_KF_rLF.ino](./HB-UNI-Sensor1-AQ-BME680_KF_rLF.ino) ändern. Jeder Sensor muss ein eineindeutiges Device ID als auch ein eindeutiges Device Serial haben!
8. Die aktuelle Version des [HB-UNI-Sensor1-AQ-BME680_KF_rLF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF) Sketches herunterladen, siehe unten.
9. Die benötigten Libraries installieren, siehe unten unter 'Benötigte Libraries'.
10. Dann den Sketch [HB-UNI-Sensor1-AQ-BME680_KF_rLF.ino](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF/HB-UNI-Sensor1-AQ-BME680_KF_rLF.ino) kompilieren und mit dem ISP Programmer auf den Arduino Pro Mini hochladen.
...
[HB-UNI-Sensor1-AQ-BME680_KF_rLF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF)

- bitte alle Unterverzeichnisse mit kopieren:

### Zur lokalen Installation des Github Releases auf Deinem Computer

- gehe bitte in Dein Zielinstallationsverzeichnis, wo Du mit dem HB-UNI-Sensor1-AQ-BME680_KF_rLF Sensor arbeiten möchtest
 ...
 -	den HB-UNI-Sensor1-AQ-BME680_KF_rLF Sensor findest Du unter './HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF'
 
- alternativ kann vom Github [Sammelrepository](https://github.com/FUEL4EP/HomeAutomation) die ZIP-Datei HomeAutomation-master.zip heruntergeladen und auf dem lokalen Rechner ausgepackt werden. Bitte dann regelmäßig auf Github nach Updates schauen.

- nach erfolgreicher Inbetriebnahme können die Debugausgaben im serial Monitor ausgeschaltet werden. Dazu bitte im Sketch HB-UNI-Sensor1-AQ-BME680_KF_rLF.ino auskommentieren:
...
### I2C Adresse des BME680 Sensors

- bitte die I2C des BME680 Sensors im Sketch hier einstellen

>     #define BME680_I2C_ADDRESS  0x77  // please adapt this to your module's I2C address, e.g. 0x77 aplies to the Joy-It BME680 module https://www.reichelt.de/entwicklerboards-sensor-bosch-bme680-debo-sens-bme680-p253653.html
 
 - es gibt Sensormodule, z.B. von joy-it, die als I2C Adresse 0x77 haben!
 - bei falsch eingestellter I2C-Adresse wird im seriellen Monitor ERR angezeigt
...
- Bosch hat im August 2022 eine [neue Version V1.8](https://www.bosch-sensortec.com/media/boschsensortec/downloads/datasheets/bst-bme680-ds001.pdf) des BME680 Datenblatts freigegeben
...
- Bitte dieses Addon 'hb-ep-devices-addon.tgz' herunterladen und vor dem Anlernen des [HB-UNI-Sensor1-AQ-BME680_KF_rLF](https://github.com/FUEL4EP/HomeAutomation/tree/master/AsksinPP_developments/sketches/HB-UNI-Sensor1-AQ-BME680_KF_rLF)
 Sensors auf der RaspberryMatic / CCU3 installieren (kein unzip vonnöten!)
- Minimal benötigte Version des Addons: 1.14
...
- das Lernen und Einschwingen der Autokalibrierungs- und des Kalman Filters hat drei Phasen:
	+ Phase 1: Neustart der Autokalibrierung und des Kalibrierung von Grund auf, wenn
		...
		* solange die durch das Kalman Filter online berechneten linearen Regressionskoeffizienten zur Kompensation der Einflüsse von Temperatur und relativer Luftfeuchte noch nicht ausreichend konvergieren, wird dieser Nichtkonvergenz-Status durch Ausgabe des Werts 3.333 auf dem Datenpunkt AQ_LOG10 angezeigt.
...
-	die ersten Monate nach Inbetriebnahme sind die Messwerte unzuverlässig(er)
-	bei einem neuen, noch nicht "eingebrannten"  BME680-Sensor sollte das Kalman-Filter nach 2..3 Monaten erneut angelernt werden, d.h. die Autokalibrierung erneut durchgeführt werden,  da sich der Widerstand des Sensors anfangs zu stark durch Alterung ändert, siehe Kapitel 'Batteriewechsel' unten.
-	der Gaswiderstandswert nimmt im Laufe der Zeit zu, kann sogar springen
