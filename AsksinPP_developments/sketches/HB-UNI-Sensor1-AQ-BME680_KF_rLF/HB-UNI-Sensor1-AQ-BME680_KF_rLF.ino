...
// normal rLF version
// (C) 03.06.2023 FUEL4EP (Creative Commons)
...
// the sensor HB-UNI-Sensor1-AQ-BME680_KF_rLF requires mandatorily an ATMega1284P MCU (e.g. Pro Mini XL - v2 - ATmega 1284p https://www.tindie.com/products/prominimicros/pro-mini-xl-v2-atmega-1284p/)
...
#include "sensors/sens_bme680_KF_rLF.h"
...
const struct DeviceInfo PROGMEM devinfo = {
  {0xf6, 0x0B, 0x01},       // Device ID             // change 0x01 to your sensor's index number, if you use multiple HB-UNI-Sensor1-AQ-BME680_KF_rLF sensors, please increase the index for each sensor by 1
  "BME6800B01",             // Device Serial         // change NAME to your name abbreviation, if you use multiple HB-UNI-Sensor1-AQ-BME680_KF_rLF sensors, please increase the index for each sensor by 1
// 1234567890                                        // device serial must be exactly 10 characters
  {0xf6, 0x0B},             // Device Model Indoor   needs to fit to Addon XML hb-uni-sensor-AQ-BME680_KF_rF.xml line 6:
                            //                       <parameter index="10.0" size="2.0" const_value="0xF60B" />
