...
class Radiation : public virtual Sensor {
protected:
  uint32_t _radiation_event_count;
public:
  Radiation () : _radiation_event_count(0) {}
  // TODO - define value range for _radiation_event_count
  uint32_t radiation_event_count () { return _radiation_event_count; }
};
