...
#endif
#if defined Tindie_m1284p
// we use a ATMega 1284p Pro Mini XL
...
//#define ACTIVE_PING
HMID PING_FROM(0x6D,0xCC,0xC5);      // from address for status message e.g. switch
HMID PING_TO(0x19,0x57,0x4d);        // to address for status message / central / CCU
#ifdef ACTIVE_PING
