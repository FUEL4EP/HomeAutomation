...
class Addon_generator {
    ...
    static void main(String... args) {
        ...
        AsksinPP_addon_control_file.translated_datapoints.datapoint.each
        {
          ...
          println "channel type           : ${it.channel_type}"
          
          if ( it.channel_type == "SKIP" ) {
            my_channel_type = ""
          }
          else {
            my_channel_type = "${it.channel_type}|"
          }
          ...
          webuiInsert_buffer.append("\n# datapoint name #${it.index}: ${my_channel_type}${it.@name}\n")
          webuiInsert_buffer.append( "webuiInsertParam=\"${my_channel_type}${it.@name}\"\n" )
          ...
          stringtable_de_txt_buffer.append("\n# datapoint name #${it.index}: ${my_channel_type}${it.@name}\n")
          stringtable_de_txt_buffer.append( " \n" )
          stringtable_de_txt_buffer.append( "stringtable_deInsert=\"${my_channel_type}${it.@name}\\t\\\${${it.string_identifier}}\"\n" )
          stringtable_de_txt_buffer.append( "if [ -z \"`cat \$stringtable_deFile | grep \\\"${my_channel_type}${it.@name}\\\"`\" ]; then\n" )
        ...
        AsksinPP_addon_control_file.translated_datapoints.datapoint.each
        {
          ...
          webuiInsert_buffer.append("\n# datapoint name #${it.index}: ${my_channel_type}${it.@name}\n")
          webuiInsert_buffer.append( "webuiSearch=\"${my_channel_type}${it.@name}\"\n" )
          webuiInsert_buffer.append( "sed -i \"/\\(\$webuiSearch\\)/d\" \$webuiFile\n\n" )
          
          
          stringtable_de_txt_buffer.append("\n# datapoint name #${it.index}: ${my_channel_type}${it.@name}\n")
          stringtable_de_txt_buffer.append( " \n" )
          stringtable_de_txt_buffer.append( "stringtable_deSearch=\"${my_channel_type}${it.@name}\"\n")
