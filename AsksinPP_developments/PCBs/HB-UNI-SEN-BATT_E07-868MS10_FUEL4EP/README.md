...
![pic](PNGs/HB-UNI-SEN-BATT_E07-868MS10_FUEL4EP_PCB_3D_top.png)
![pic](Pictures_of_JLCPCB_prototypes/HB-UNI-SEN-BATT_E07-868MS10_FUEL4EP_PCB_top_JLCPCB_V1.4_not_assembled_prototype.png)
![pic](Pictures_of_JLCPCB_prototypes/HB-UNI-SEN-BATT_E07-868MS10_FUEL4EP_PCB_bottom_JLCPCB_V1.4_not_assembled_prototype.png)
...
- der Prototyp der neuen Platinenversion V1.4 wurde bei JLCPCB gefertigt, ist aber noch nicht validiert worden
...
* Mikroschalter 6*6mm
* Stiftleiste RM 1.27mm 1x8 Pin (für eByte E07-868MS10 Modul)
...
![pic](./Jumper_settings/jumper_settings_HB-UNI-SEN-BATT_E07-868MS10_FUEL4EP.png)

- die Tabellen dazu sind [hier](./Jumper_settings) zu finden
    
## lokale Installation des Github Releases auf Deinem Computer

- gehe bitte in Dein Zielinstallationsverzeichnis, wo Du mit der HB-UNI-SEN-BATT_E07-868MS10_FUEL4EP Platine mit KiCAD arbeiten möchtest

  - gebe dort 'git clone https://github.com/FUEL4EP/HomeAutomation.git' ein
	  + damit lädst Du mein [Sammelrepository](https://github.com/FUEL4EP/HomeAutomation) für alle meine auf Github freigegebenen HomeBrew Entwicklungen herunter.
  - dann findest Du ein neues Verzeichnis 'HomeAutomation' auf Deinem Rechner, das alle meine auf Github freigebenen Entwicklungen enthält, siehe [README.md](https://github.com/FUEL4EP/HomeAutomation/blob/master/README.md)
  	+ mache bitte regelmäßig ein Update mit 'git pull'
 -	die Platine HB-UNI-SEN-BATT_E07-868MS10_FUEL4EP findest Du unter './HomeAutomation/tree/master/AsksinPP_developments/PCBs/HB-UNI-SEN-BATT_E07-868MS10_FUEL4EP'
